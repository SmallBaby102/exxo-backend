...
const { webhook, getUsers, removeUsers, updateUsers, getTradingAccounts, getOffers, createTradingAccount, 
    createTradingAccountsOfAllAccounts, changePassword, verifyProfile, updateStatus } = require("../controllers/user");
...
router.post("/tradingAccountsOfAllAccounts", [ authJwt.verifyToken ], createTradingAccountsOfAllAccounts);
